...
class CTLR_SUB:
    def __init__(self):
        ...
        self.steer_pub= rospy.Publisher('/pololu/command/', MC, queue_size = 1)
        self.throttle_pub= rospy.Publisher('/pololu/command/', MC, queue_size = 1)
    ...
    def throttle_listen(self, msg):
        ...
        self.throttle_pub.publish(output)
